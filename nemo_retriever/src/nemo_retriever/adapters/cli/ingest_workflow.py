...
def service_ingest_request_to_dry_run_data(request: ServiceIngestRequest) -> dict[str, Any]:
    ...
    return {
        ...
        "extract": params_to_dry_run_dict(request.extract_params),
        "split_config": params_to_dry_run_dict(service_split_config_for_request(request)),
        "dedup": params_to_dry_run_dict(request.dedup_params),
        "caption": params_to_dry_run_dict(request.caption_params),
        "embed": params_to_dry_run_dict(request.embed_params),
        "store": params_to_dry_run_dict(request.store_params),
    }
