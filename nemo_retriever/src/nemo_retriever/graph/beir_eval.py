...
"""BEIR Evaluator — Designer component for running BEIR evaluation against a VDB.
...
@designer_component(
    ...
    category="Evaluation",
    compute="cpu",
    description="Runs BEIR evaluation against a VDB and prints the standard run summary",
